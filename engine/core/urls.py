...
urlpatterns = [
    ...
    path('prompts/refresh-domain/', views.start_domain_prompt_refresh, name='start_domain_prompt_refresh'),
    ...
    path('seo/process-new-keywords/', views.seo_process_new_keywords, name='seo_process_new_keywords'),
