  ...
  return (
    <div className="flex-1 p-6 md:p-8 max-w-6xl mx-auto w-full">
      ...
      <div className="flex items-center gap-3 mb-8">
        <Button variant="ghost" size="icon" className="h-9 w-9" onClick={() => navigate('/seo-rankings')}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Left Column - Domain/URL/Region/Language/Platform */}
        ...
        <div className="space-y-3">
          ...
          {inputMode === 'text' ? (
            <div className="space-y-3">
              ...
              />
              {keywords.length > 0 && (
                <div className="rounded-md border border-input bg-background p-3 min-h-[200px] max-h-[300px] overflow-y-auto">
                  <div className="flex flex-wrap gap-1.5">
                    {keywords.map((kw, idx) => (
                      <Badge key={`${kw}-${idx}`} variant="secondary" className="gap-1">
                        {kw}
                        <button
          ...
          {tagsEnabled && (
            <>
              ...
              {allDomainTags.length > 0 && (
                <div>
                  <p className="text-xs font-medium text-muted-foreground uppercase mb-2">Other tags in this project</p>
                  <div className="flex flex-wrap gap-1.5">
      ...
      {/* Result */}
      {result && (
        <div className="rounded-lg border border-border bg-muted/30 p-4 space-y-1 mt-8">
          <p className="text-sm font-medium text-green-600">Keywords Added Successfully</p>
          <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs text-muted-foreground max-w-xs">
      ...
      <div className="flex items-center justify-end gap-3 mt-8 pt-6 border-t">
        <Button variant="outline" onClick={() => navigate('/seo-rankings')}>
          Cancel
        </Button>
        {!result ? (
          <Button
          ...
          <Button className="gradient-primary" onClick={handleReset}>
            Add More
          </Button>
        )}
      </div>
