              ...
              <div className="space-y-3 pt-3 border-t">
                ...
                {mention.citations && mention.citations.length > 0 && (
                  <div className="space-y-2">
                    {mention.citations.slice(0, 2).map((citation, idx) => (
                    ...
                    {mention.citations.length > 2 && (
                      <p className="text-xs text-muted-foreground italic">
                        +{mention.citations.length - 2} more citation{mention.citations.length - 2 > 1 ? 's' : ''} available in full details
                      </p>
                    )}
                  </div>
                )}
