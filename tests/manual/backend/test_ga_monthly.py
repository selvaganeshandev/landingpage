...
Usage:
    python tests/manual/backend/test_ga_monthly.py "CanaraHSBCLife Insurance"
    python tests/manual/backend/test_ga_monthly.py "Appkodes"
    python tests/manual/backend/test_ga_monthly.py "Hitasoft"
"""
